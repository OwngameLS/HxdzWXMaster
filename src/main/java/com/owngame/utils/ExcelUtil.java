...
//            Workbook workbook = WorkbookFactory.create(fileStream);
            ...
            for (int i = 1; i < rowNumbers; i++) {
                ...
                if (null != row.getCell(4)) {
                    ...
                    System.out.println("phone number :" + tempS);
    ...
    public static boolean initContactsFile(String filePath, ArrayList<Contact> contacts){
        ...
        try {
            ...
            // 定义单元格为字符串类型
            cell.setCellType(HSSFCell.ENCODING_UTF_16);// 中文处理
            cell.setCellValue(new HSSFRichTextString("组名"));
            cell = row.createCell(2);
            // 定义单元格为字符串类型
            cell.setCellType(HSSFCell.ENCODING_UTF_16);// 中文处理
            cell.setCellValue(new HSSFRichTextString("人名"));
            ...
            // 定义单元格为字符串类型
            cell.setCellType(HSSFCell.ENCODING_UTF_16);// 中文处理
            cell.setCellValue(new HSSFRichTextString("电话号码"));
