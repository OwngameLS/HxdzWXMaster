...
wrap.children("div.datagrid-pagerContacts").each(function(){
...
$("div.datagrid-pagerContacts",_4cc).remove();
if(opts.pagination){
var _4d1=$("<div class=\"datagrid-pagerContacts\"></div>");
if(opts.pagePosition=="bottom"){
_4d1.appendTo(_4cc);
}else{
if(opts.pagePosition=="top"){
_4d1.addClass("datagrid-pagerContacts-top").prependTo(_4cc);
}else{
var ptop=$("<div class=\"datagrid-pagerContacts datagrid-pagerContacts-top\"></div>").prependTo(_4cc);
_4d1.appendTo(_4cc);
_4d1=_4d1.add(ptop);
}
}
...
return $.data(jq[0],"datagrid").panel.children("div.datagrid-pagerContacts");
